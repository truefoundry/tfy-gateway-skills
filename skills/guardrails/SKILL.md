...
3. **Deploy** — Use the `deploy` skill from the [`tfy-deployment-agent-skills`](https://github.com/truefoundry/tfy-deployment-agent-skills) package to deploy the resulting service (Dockerfile or build from source as in the template).
