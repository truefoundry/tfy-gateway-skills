...
3. **Deploy** — Use the `deploy` skill from the [`tfy-deploy-skills`](https://github.com/truefoundry/tfy-deploy-skills) package to deploy the resulting service (Dockerfile or build from source as in the template).
