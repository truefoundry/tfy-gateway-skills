...
- **Before registering**: Deploy the MCP server as a service (use `deploy` skill from [`tfy-deployment-agent-skills`](https://github.com/truefoundry/tfy-deployment-agent-skills)), set up teams/roles for collaborators (use `access-control` skill)
