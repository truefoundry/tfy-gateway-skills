...
- **With deployments**: Use `applications` skill (from [`tfy-deployment-agent-skills`](https://github.com/truefoundry/tfy-deployment-agent-skills)) to check deployed services that consume prompts
