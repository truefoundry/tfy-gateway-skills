...
- User wants to deploy → requires `tfy-deployment-agent-skills` package (see https://github.com/truefoundry/tfy-deployment-agent-skills)
...
>
> **Deploy & Run** (requires `tfy-deployment-agent-skills` package — see https://github.com/truefoundry/tfy-deployment-agent-skills)
...
- **First deployment** → requires `tfy-deployment-agent-skills` package (see https://github.com/truefoundry/tfy-deployment-agent-skills)
